...
public class OrderAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, final ViewGroup parent) {
        ...
        String itemTotalPrice = String.valueOf(Integer.valueOf(orderInfo.getCount() + 1) * (Integer.valueOf(orderInfo.getOrderedprice())));
        holder.price.setText(itemTotalPrice);
        Picasso.with(context).load(orderInfo.getOrderedimage()).into(holder.img_product);
        holder.orderid.setText(orderInfo.getCount() + 1 + " ");
